  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      const handleScroll = () => {
        ...
        const bgScaleValue =
          window.scrollY >= 1138
            ? currentScaleSize.current ?? 0
            : 1 + window.scrollY / 5000;
    ...
    <>
      <div
        ...
        style={{ 
          ...
          filter: `blur(${blur}px)`, 
          display: scrollY > 1138 ? "none" : "block"
        }}
      >
        <Image
          src={firstBG}
      ...
      <div className="w-full h-[2500px] flex justify-center mb-[120px]">
        <div
          className={`sticky top-10 left-0 h-[800px] w-auto`}
